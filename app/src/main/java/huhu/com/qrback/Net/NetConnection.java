...
public class NetConnection {
     ...
     * @param kvs
     */
    public NetConnection(final String url, final HttpMethod method, final SuccessCallback successCallback, final FailCallback failCallback, final ArrayList<String> list, final String... kvs) {
        ...
        new AsyncTask<Void, Void, String>() {
            ...
            protected String doInBackground(Void... arg0) {
                ...
                for (int i = 0; i < list.size(); i++) {
                    paramsStr.append("spoint").append("=").append(list.get(i)).append("&");
                }
